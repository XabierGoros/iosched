...
object Libs {
    ...
    const val ROOM_COMPILER = "androidx.room:room-compiler:2.4.0-alpha03"
    const val ROOM_KTX = "androidx.room:room-ktx:2.4.0-alpha03"
    const val ROOM_RUNTIME = "androidx.room:room-runtime:2.4.0-alpha03"
